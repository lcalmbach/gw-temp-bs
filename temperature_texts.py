...
"fig1": "Figure 1: Location of stations with available groundwater temperature observations. Use the cursor to discover the depth and mean temperature for these locations.",
...
Figure 2 shows the spatial distribution of the different trend test results: *increasing* (orange), *decreasing* (blue), and *no trend* (gray). This map does not allow to delineate ares of a common trend pattern. The differnece of trend and average temperature, that can be observed in nearby stations suggests that manmade processes may impact the natural groundwater regime in this urban area. Further knowledge of the local groundwater flow system should be included in order to interpret the spatial distribution of temperature time series.
""",
